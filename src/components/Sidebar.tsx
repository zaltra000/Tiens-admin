            ...
            <motion.div variants={itemVariants} className="p-8 pt-6">
              <div className="bg-gray-50 dark:bg-zinc-800/50 rounded-3xl p-5 border border-gray-100 dark:border-zinc-800 transition-colors duration-500">
                ...
                <div className="flex gap-3 justify-center">
                  ...
                  <a href={`https://wa.me/249908335222`} target="_blank" rel="noreferrer" className="w-10 h-10 flex items-center justify-center bg-white dark:bg-zinc-700 border border-gray-200 dark:border-zinc-600 rounded-full hover:border-green-500/50 hover:shadow-md transition-all group active:scale-95">
